      ...
      <div className={`flex-1 p-4 sm:p-6 md:p-8 ${isMobile ? "" : "md:ml-64"}`}>
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label className="font-medium">Measurement System</Label>
                <p className="text-sm text-muted-foreground">Choose your preferred units</p>
              </div>
              <RadioGroup value={useMetric ? "metric" : "imperial"} onValueChange={(v) => setUseMetric(v === "metric")} className="flex space-x-4">
