...
import { Bold, Italic, Heading1, Heading2, List, ListOrdered, CheckSquare, Quote, ImagePlus, Minus } from 'lucide-react';
...
const RichTextEditor: React.FC<RichTextEditorProps> = ({ value, onChange, placeholder = 'Write something...', minRows = 8 }) => {
  ...
  return (
    <div className="border border-input rounded-lg overflow-hidden bg-background">
      <div className="flex items-center gap-0.5 p-1.5 border-b border-input bg-muted/30 flex-wrap">
        ...
        <Button type="button" variant="ghost" size="sm" className="h-8 w-8 p-0 hover:bg-primary/10 hover:text-primary" onClick={handleImageInsert} title="Image">
