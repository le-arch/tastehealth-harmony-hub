  ...
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <div className="space-y-2">
        ...
        <select id="gender" className="input" value={formData.gender} onChange={e => onChange('gender', e.target.value)}>
    ...
    <div className="space-y-3">
      ...
      <select id="activityLevel" className="input" value={formData.activityLevel} onChange={e => onChange('activityLevel', e.target.value)}>
    ...
    <div className="space-y-3">
      ...
      <select id="goal" className="input" value={formData.goal} onChange={e => onChange('goal', e.target.value)}>
