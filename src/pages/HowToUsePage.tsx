...
const HowToUsePage = () => {
  ...
  const tutorialSteps = [
    ...
    { id: 4, title: "Plan Your Weekly Meals", description: "Build and edit weekly meal plans in one place", icon: <Calendar className="h-6 w-6" />, path: "/meal-planning", details: ["Open Meal Planning → Meal Timetable tab to plan the week", "Use the Create button to start a new weekly plan", "Search meals from a 350+ recipe library", "Each scheduled meal auto-syncs to Today's Meal"], tips: "Plans are weekly — create a new one for each new week.", priority: "Weekly", color: "from-amber-500 to-yellow-500" },
