    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="space-y-4 sm:space-y-6">
        <div className="bg-muted/30 p-3 sm:p-4 rounded-md">
          <h3 className="font-medium mb-2 sm:mb-3 text-sm sm:text-base">Daily Calorie Goal</h3>
          <div className="text-xl sm:text-2xl font-bold">{formData.dailyCalories} kcal</div>
        </div>
        <div className="space-y-3 sm:space-y-4">
          <h3 className="font-medium text-sm sm:text-base">Macronutrient Distribution</h3>
          <div className="grid grid-cols-3 gap-2 sm:gap-4">
            <div className="bg-nutrition-protein/10 p-2 sm:p-4 rounded-md text-center">
              ...
              <div className="text-xs sm:text-sm">{Math.round((formData.dailyCalories * formData.proteinPercentage / 100) / 4)}g</div>
            </div>
            <div className="bg-nutrition-carbs/10 p-2 sm:p-4 rounded-md text-center">
              ...
              <div className="text-xs sm:text-sm">{Math.round((formData.dailyCalories * formData.carbsPercentage / 100) / 4)}g</div>
            </div>
            <div className="bg-nutrition-fats/10 p-2 sm:p-4 rounded-md text-center">
              <div className="text-xs sm:text-sm text-muted-foreground">Fats</div>
              <div className="text-lg sm:text-xl font-bold">{formData.fatsPercentage}%</div>
              <div className="text-xs sm:text-sm">{Math.round((formData.dailyCalories * formData.fatsPercentage / 100) / 9)}g</div>
            </div>
          </div>
        </div>
        <div className="pt-2">
