...
const HowToUsePage = () => {
  ...
  const tutorialSteps = [
    ...
    { id: 10, title: "Watch Cooking Videos", description: "Learn healthy cooking techniques", icon: <Video className="h-6 w-6" />, path: "/cooking-videos", details: ["Browse videos by meal category", "Watch step-by-step cooking guides", "Get inspiration for your weekly meal prep"], tips: "Visual learning makes cooking new recipes much easier!", priority: "Anytime", color: "from-red-500 to-pink-500" },
    { id: 11, title: "Read Daily Health Tips", description: "Expert wellness advice delivered daily", icon: <Stethoscope className="h-6 w-6" />, path: "/health-tips", details: ["Read 4 curated health tips every day", "Tips cover nutrition, exercise, sleep, and wellness", "Evidence-based advice from health experts"], tips: "Small daily tips compound into big health improvements over time!", priority: "Daily", color: "from-cyan-500 to-blue-500" },
